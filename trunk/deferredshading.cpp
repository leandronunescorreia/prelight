...
const tstring DeferredShading::m_DefaultDiffuseMapFilename(_T("basetex.bmp"));
const tstring DeferredShading::m_DefaultNormalMapFilename(_T("wavy_normal.dds"));
const tstring DeferredShading::m_DefaultEnvironmentMapFilename(_T("NV-Metal-b.dds"));
...
//-----------------------------------------------------------------------------
HRESULT DeferredShading::OneTimeSceneInit()
{
	srand(0);
...
HRESULT DeferredShading::LoadShaders(IDirect3DDevice9* pd3dDevice)
{
    ...
    hr = D3DXCreateEffectFromFile(pd3dDevice, GetFilePath::GetFilePath(_T("programs\\DeferredShading\\DeferredShading.fx")).c_str(),
